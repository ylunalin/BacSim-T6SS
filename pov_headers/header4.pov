// For visualizing T6+ FQ2 and T6- FQ1
#version 3.6;
#include "colors.inc"
#include "metals.inc"
...
#declare t0=texture{pigment{rgb <0.95,0.22,0.18>} finish{f0}} // RED, nonlethal
#declare t1=texture{pigment{rgb <0.3,0.8,0.9>} finish{f0}} // CYAN, lethal
